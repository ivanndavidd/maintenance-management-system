...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <a href="{{ route('supervisor.my-tasks.corrective-maintenance') }}" class="text-decoration-none">
                <i class="fas fa-arrow-left me-2"></i>Back to My Tickets
            </a>
            <h4 class="mt-2"><i class="fas fa-ticket-alt me-2"></i>{{ $ticket->ticket_number }}</h4>
            @if($ticket->parentTicket)
                <small class="text-muted">
                    <i class="fas fa-link me-1"></i>Sub-ticket of
                    <a href="{{ route('supervisor.my-tasks.corrective-maintenance.show', $ticket->parentTicket) }}">{{ $ticket->parentTicket->ticket_number }}</a>
                </small>
            @endif
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            @else
                                <form action="{{ route('supervisor.my-tasks.corrective-maintenance.acknowledge', $ticket) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PATCH')
                ...
                <div class="card-body">
                    ...
                    <div class="bg-info bg-opacity-10 p-3 rounded mb-3 border-start border-info border-3">
                        ...
                        <div class="text-muted small mt-2">
                            <i class="fas fa-link me-1"></i>From: <a href="{{ route('supervisor.my-tasks.corrective-maintenance.show', $ticket->parentTicket) }}">{{ $ticket->parentTicket->ticket_number }}</a>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h6 class="mb-1">
                                        <a href="{{ route('supervisor.my-tasks.corrective-maintenance.show', $childTicket) }}" class="text-decoration-none">
...
<div class="modal fade" id="submitReportModal" tabindex="-1" data-bs-backdrop="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('supervisor.my-tasks.corrective-maintenance.submit-report', $ticket) }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="groupAssetSelect_sup" class="form-select">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="asset_id" id="assetId_sup" class="form-select" required disabled>
...
<script>
(function() {
    const groupSel = document.getElementById('groupAssetSelect_sup');
    const assetSel = document.getElementById('assetId_sup');
    if (!groupSel || !assetSel) return;

    const allOptions = Array.from(assetSel.options).slice(1); // skip placeholder
