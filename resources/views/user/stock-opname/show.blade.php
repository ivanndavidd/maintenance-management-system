...
<div class="container-fluid">
    <div class="mb-4">
        <h2><i class="fas fa-clipboard-check"></i> Stock Opname Details</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            {{-- Filter Form --}}
            <form method="GET" action="{{ route('user.stock-opname.show', $schedule) }}" class="mb-3">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('user.stock-opname.show', $schedule) }}" class="btn btn-secondary btn-sm">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('user.stock-opname.export-template', $schedule) }}" class="btn btn-primary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('saveAllBtn').addEventListener('click', function() {
        ...
        // Send batch request
        fetch('/user/stock-opname/execute-batch', {
            method: 'POST',
            headers: {
    ...
    importForm.addEventListener('submit', function(e) {
        ...
        fetch('{{ route('user.stock-opname.import-excel', $schedule) }}', {
            method: 'POST',
            body: formData,
            headers: {
                'Accept': 'application/json',
