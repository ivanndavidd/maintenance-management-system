    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            @if($schedule->status === 'draft')
                <form action="{{ route('admin.preventive-maintenance.activate', $schedule) }}" method="POST" class="d-inline">
                    @csrf
                    @method('PATCH')
            ...
            @endif
            <a href="{{ route('admin.preventive-maintenance.edit', $schedule) }}" class="btn btn-warning">
