...
<body>
    <div class="container">
        <div class="header">
            <h1 style="margin: 0;">PM Task Completed</h1>
            <p style="margin: 10px 0 0 0;">A preventive maintenance task has been completed</p>
        </div>

        <div class="content">
            <p>Dear Team,</p>

            <p>A preventive maintenance task has been successfully completed. Please review the details below.</p>
            ...
            <div class="task-info">
                ...
                <table>
                    ...
                    <tr>
                        <td>Completed By</td>
                        <td><strong>{{ $task->assignedUser->name ?? 'N/A' }}</strong></td>
                    </tr>
                    <tr>
                        <td>Completed At</td>
            ...
            <p>This notification is sent to keep you informed about the completion of preventive maintenance tasks. No action is required unless you need to review the task details.</p>
        </div>
