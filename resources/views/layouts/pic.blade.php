...
<head>
    ...
    <title>{{ config('app.name', 'Warehouse Maintenance') }} - PIC</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('pic.incident-reports.index') }}" class="{{ request()->routeIs('pic.incident-reports.*') ? 'active' : '' }}">
                <i class="fas fa-exclamation-triangle"></i>
                <span>Report Incident</span>
            </a>

            <a href="{{ route('pic.task-requests.index') }}" class="{{ request()->routeIs('pic.task-requests.*') ? 'active' : '' }}">
